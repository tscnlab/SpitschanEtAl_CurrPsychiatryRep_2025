...
load(url("https://raw.githubusercontent.com/MeLiDosProject/Sancho-SalasEtAl_Dataset_2025/main/data/imported/light/light_chest_1minute.RData"))
...
load(url("https://raw.githubusercontent.com/MeLiDosProject/Sancho-SalasEtAl_Dataset_2025/main/data/imported/demographics.RData"))
```
...
data_5min_red |> 
  ...
  mutate(Id = fct_relevel(Id, "UCR_S010", "UCR_S003", "UCR_S009"),
         Id = fct_recode(Id,
                         "**A** High daytime & low nighttime levels" = "UCR_S010",
                         "**B** High nighttime levels" = "UCR_S003",
                         "**C** Low daytime levels" = "UCR_S009"),
  ...
  theme(
        ...
        strip.text = element_textbox_simple(size = 15, padding = margin(2, 0, 1, 0), margin = margin(3, 3, 3, 3))
  ) +
...
data_5min_red |> 
  ...
  ggplot2::theme(
    ...
    strip.text = 
      element_textbox_simple(color = "white", size = 15, padding = margin(2, 0, 1, 0), margin = margin(3, 3, 3, 3)), 
...
ggsave("../figures/Figure_3.pdf", width = 8*1.5, height = 7*1.5, scale = 2, units = "cm")
ggsave("../figures/Figure_3.png", width = 8*1.5, height = 7*1.5, scale = 2, units = "cm")
```
