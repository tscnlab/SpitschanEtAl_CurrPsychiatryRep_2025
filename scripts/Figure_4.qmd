...
```{r}
#| label: import logs
path <- here("data/event_log_LightLamp.xlsx")
#import log data
...
```{r}
path_lamp <- here("assets/5541.png")
path_default <- here("assets/4789.png")
...
Plot2
# ggsave(here("figures/Figure1.pdf"), width = 5, height = 5, scale = 2)
...
(merge((Plot1 + labs(title = "**A** Intensity at eye level") + Plot2 + labs(title = "**B** Cumulative exposure")) /
  light_histogram + labs(title = "**C** Intensity distributions of experimental conditions") + plot_layout(heights = c(3,2))) /
  # wrap_table(tbl_comparison, panel = "full", space = "fixed") +
  (wrap_table(tbl_comparison, panel = "full", space = "fixed") + labs(title = "**D** Tabular summary of experimental conditions") ) +
  plot_annotation(caption = 
                    "Note: interruptions from the protocol (e.g. restroom times) were removed.")) &
  theme(plot.tag = element_text(face = "bold"),
        plot.title.position = "panel",
        plot.title = element_textbox_simple(size = 15, face = "plain", padding = margin(2, 0, 1, 0), margin = margin(3, 3, 3, 3)))

 ggsave(here("figures/Figure_4.pdf"), width = 8, height = 6, scale = 1.5)
  ggsave(here("figures/Figure_4.png"), width = 8, height = 6, scale = 1.5)
```
